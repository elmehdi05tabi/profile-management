<div class="p-2 border border-gray-200 my-2 mx-auto w-50 bg-light">
    <div class="card p-2  d-flex my-3 align-items-center justify-content-center gap-3">
        <img class="rounded-circle" height="50px" width="50px" src="<?php echo e(asset('storage/' . $publication->profile->image)); ?>"
            alt="">
    ...
    <?php if(auth()->guard()->check()): ?>
        <div class="forms">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $publication)): ?>
                <a href="<?php echo e(route('publications.edit', $publication->id)); ?>" class="btn btn-sm  btn-outline-success">Modifier</a>
            <?php endif; ?>
    ...
    <?php if($publication->image): ?>
        <img src="<?php echo e(asset('storage/' . $publication->image)); ?>" alt="image" class="img-fluid img-rounde">
    <?php endif; ?>

</div>
<?php /**PATH C:\laravel_tutorial\resources\views/components/publications.blade.php ENDPATH**/ ?>