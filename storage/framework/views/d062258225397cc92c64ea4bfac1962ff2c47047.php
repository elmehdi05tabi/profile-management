...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.master','data' => ['title' => 'create profile']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'create profile']); ?>
...
<?php endif; ?>
    ...
    <form action="<?php echo e(route('profiles.store')); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <textarea type="text" name="bio" class="form-control"><?php echo e(old('bio')); ?></textarea>
        </div>
        <div class="mb-3">
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH C:\laravel_tutorial\resources\views/profiles/create.blade.php ENDPATH**/ ?>