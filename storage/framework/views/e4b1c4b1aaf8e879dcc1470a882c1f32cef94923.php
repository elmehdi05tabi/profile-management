<div class="col-lg-3 my-5">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p class="card-text"><?php echo e(Str::limit($profile->bio,20)); ?></p>
            <a  class="stretched-link" href="<?php echo e(route('profiles.show',$profile->id)); ?>"></a>
        </div>
        <div class="card-foot border-top bg-light px-3 py-3 d-flex justify-content-center gap-3" style="z-index: 10">
            ...
            <form action="<?php echo e(route('profiles.edit',$profile->id)); ?>"  method="GET">
